...
(def-doom-theme doom-gruvbox-material
  ...
  ((button :foreground cyan :underline t :weight 'bold)
   ...
   ;;;; tree-sitter
   (tree-sitter-hl-face:function.call    :foreground green :bold t)
   (tree-sitter-hl-face:property         :foreground fg)
   (tree-sitter-hl-face:string          :foreground dark-cyan)
   (tree-sitter-hl-face:type          :foreground yellow)
   (tree-sitter-hl-face:type.builtin          :foreground yellow :italic t)
   (tree-sitter-hl-face:annotation         :foreground violet)
   (tree-sitter-hl-face:attribute         :foreground violet)
   (tree-sitter-hl-face:boolean         :foreground violet)
   (tree-sitter-hl-face:character         :foreground dark-cyan)
